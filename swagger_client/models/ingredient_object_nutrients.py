...
class IngredientObjectNutrients(object):
    ...
    def __init__(self, usda=None):  # noqa: E501
    ...
    @property
    def usda(self):
        """Gets the usda of this IngredientObjectNutrients.  # noqa: E501

        An array containing an object for each nutrient data point as found in the USDA database  # noqa: E501

        :return: The usda of this IngredientObjectNutrients.  # noqa: E501
