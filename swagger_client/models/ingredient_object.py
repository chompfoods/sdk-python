...
class IngredientObject(object):
    ...
    def __init__(self, items=None):  # noqa: E501
        """IngredientObject - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this IngredientObject.  # noqa: E501

        An array containing an object for each individual item returned by your API call.  # noqa: E501

        :return: The items of this IngredientObject.  # noqa: E501
    ...
    def items(self, items):
        ...
        :type: list[IngredientObjectItems]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IngredientObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IngredientObject):
            return False
